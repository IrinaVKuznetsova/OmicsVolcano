...
```diff
! *OmicsVolcano Version 1.0 for R is available 06/05/2020  
```
...
**OmicsVolcano [help page](https://github.com/IrinaVKuznetsova/OmicsVolcano) was designed to help people to use the OmicsVolcano App**  

 
General Usage Notes  
------

**Description:** OmicsVolcano is the R App for intuitive visualization and interactive exploration of high throughput biological data in a volcano plot  
Unique feature of this programm is the possibility to explore Mitochodrial Process(es) present in the data  


**App architecture:**  
Anyone with RStuio can run the OmicsVolcano App   
Brief Algorithm Description  
------
OmicsVolcano workflow:   
...
**Version control OmicsVolcano Version 1.0 R 3+:**  
...
![visualization generated by OmicsVolcano](https://github.com/IrinaVKuznetsova/OmicsVolcano)  
