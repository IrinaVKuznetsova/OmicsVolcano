...
#  })
  ...
  DataInputFile = reactive ( {
    ...
    print(c("Loading File:", input$UI_INPUT_FILE_NAME))
    ...
    tryCatch(
      ...
      error = function(e) {
        ...
        displayErrorMessage("File Loading Error!", "Please review the documentation of this software to understand the file structure that is required", "")
    ...
    if (input$UI_INPUT_FILE_REMOVE_DUPLICATES==TRUE) {
      ...
      # ARTUR: REMOVE THE DUPLICATES OF THE FILE (WRITE A SEPARATE FUNCTION)
    }
  ...
  # 1.1.0 OUTPUT SIGNIF. to TABs: "Explore Plot Values" AND to "Explore Mitrochondrial Processes"
  ...
  MitoProcesses = reactive ({  # observe({
  ...
  DataFrameWithColors = reactive({
    ...
    # ARTUR if no data file here, then don't executre this one
  ...
  ExplorePlotVolPplot = reactive ({ # observe({
    ...
    VolcanoPlotExplore_plotly = ggplotly( VolcanoPlotExplore, tooltip = "text") %>%
      highlight(on = "plotly_click", off = "plotly_doubleclick", dynamic = TRUE, persistent = TRUE, color = "#777777",
  ...
  ###########################################################################################################
  # 3. VISUALISE ("Explore Mitrochondrial Processes") | crosstalk btw table and plot 
  ###########################################################################################################
  # 3.0 Input data 
  ...
  # 5.1 DOWNLOAD | Visualisation output   svg", "pdf", "jpeg", "png", "tiff"
  # observeEvent(input$DownloadPlot, {
  #   paste( input$PlotDownload, "_", format(Sys.Date(), "%d%b%Y"), paste(".", input$Plotfiletype, sep=""), sep="")
  #   export(p = ExplorePlotVolPplot(), file.path(getwd(), filename), format= input$Plotfiletype)
  # })
  # if(input$PlotDownload == "Explore Plot Values"){
  #   filename = paste( input$PlotDownload, "_", format(Sys.Date(), "%d%b%Y"), paste(".", input$Plotfiletype, sep=""), sep="")
  #   orca(p = ExplorePlotVolPplot(), file.path(getwd(), filename), format= input$Plotfiletype)
  # }
  # else if(input$PlotDownload == "Explore Mitrochondrial Processes"){
  #   filename = paste( input$PlotDownload, "_", format(Sys.Date(), "%d%b%Y"), paste(".", input$Plotfiletype, sep=""), sep="")
  #   orca(p = StorePlotForExplore$image0, file=file.path(getwd(), filename))
  # }
  ...
  output$DownloadPlot = downloadHandler(
    #observe(print(paste(input$PlotDownload, "_", format(Sys.Date(), "%d%b%Y"), paste(".", input$Plotfiletype, sep=""), sep=""))),
    filename = function(){
      ...
      else if (input$PlotDownload == "Explore Mitrochondrial Processes" & input$Plotfiletype == "png"){
        paste( input$PlotDownload, "_", format(Sys.Date(), "%d%b%Y"), paste(".", input$Plotfiletype, sep=""), sep="")}
      else if (input$PlotDownload == "Explore Mitrochondrial Processes" & input$Plotfiletype == "pdf"){
        paste( input$PlotDownload, "_", format(Sys.Date(), "%d%b%Y"), paste(".", input$Plotfiletype, sep=""), sep="")}
      else if (input$PlotDownload == "Explore Mitrochondrial Processes" & input$Plotfiletype == "svg"){
        paste( input$PlotDownload, "_", format(Sys.Date(), "%d%b%Y"), paste(".", input$Plotfiletype, sep=""), sep="")}
      else if (input$PlotDownload == "Explore Mitrochondrial Processes" & input$Plotfiletype == "jpeg"){
        paste( input$PlotDownload, "_", format(Sys.Date(), "%d%b%Y"), paste(".", input$Plotfiletype, sep=""), sep="")}
      else if (input$PlotDownload == "Explore Mitrochondrial Processes" & input$Plotfiletype == "tiff"){
        paste( input$PlotDownload, "_", format(Sys.Date(), "%d%b%Y"), paste(".", input$Plotfiletype, sep=""), sep="")}
    ...
    content = function(file){
      if (     input$PlotDownload == "Explore Plot Values" & input$Plotfiletype == "png"){
        ggsave(file, plot = StorePlotForExplore$image0, device = "png",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Plot Values" & input$Plotfiletype == "pdf"){
        ggsave(file, plot = StorePlotForExplore$image0, device = "pdf",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Plot Values" & input$Plotfiletype == "svg"){
        ggsave(file, plot = StorePlotForExplore$image0, device = "svg",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Plot Values" & input$Plotfiletype == "jpeg"){
        ggsave(file, plot = StorePlotForExplore$image0, device = "jpeg",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Plot Values" & input$Plotfiletype == "tiff"){
        ggsave(file, plot = StorePlotForExplore$image0, device = "tiff",  width = 400, height = 300, dpi= 1200, units = "mm")}
      
      else if (input$PlotDownload == "Explore Mitrochondrial Processes" & input$Plotfiletype == "png"){
        ggsave(file, plot = ExploreMitoVolcanoStore$image1, device = "png",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Mitrochondrial Processes" & input$Plotfiletype == "pdf"){
        ggsave(file, plot = ExploreMitoVolcanoStore$image1, device = "pdf",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Mitrochondrial Processes" & input$Plotfiletype == "svg"){
        ggsave(file, plot = ExploreMitoVolcanoStore$image1, device = "svg",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Mitrochondrial Processes" & input$Plotfiletype == "jpeg"){
        ggsave(file, plot = ExploreMitoVolcanoStore$image1, device = "jpeg",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Mitrochondrial Processes" & input$Plotfiletype == "tiff"){
        ggsave(file, plot = ExploreMitoVolcanoStore$image1, device = "tiff",  width = 400, height = 300, dpi= 1200, units = "mm")}
      
      else if (input$PlotDownload == "Explore Custom Gene List" & input$Plotfiletype == "png"){
        ggsave(file, plot = CustomVolcanoPlotStore$image2, device = "png",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Custom Gene List" & input$Plotfiletype == "pdf"){
        ggsave(file, plot = CustomVolcanoPlotStore$image2, device = "pdf",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Custom Gene List" & input$Plotfiletype == "svg"){
        ggsave(file, plot = CustomVolcanoPlotStore$image2, device = "svg",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Custom Gene List" & input$Plotfiletype == "jpeg"){
        ggsave(file, plot = CustomVolcanoPlotStore$image2, device = "jpeg",  width = 400, height = 300, dpi= 1200, units = "mm")}
      else if (input$PlotDownload == "Explore Custom Gene List" & input$Plotfiletype == "tiff"){
        ggsave(file, plot = CustomVolcanoPlotStore$image2, device = "tiff",  width = 400, height = 300, dpi= 1200, units = "mm")}
    })
